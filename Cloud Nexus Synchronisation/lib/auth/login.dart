...
import 'package:lahmerproject/Components/AuthSocial.dart';
import 'package:lahmerproject/Components/GlobalWidget.dart';
import 'package:lahmerproject/Components/GoogleAuth.dart';
import 'package:lahmerproject/Components/LoginWithPopUp.dart';
import 'package:lahmerproject/Components/PasswordCustom.dart';
import 'package:lahmerproject/Components/TextFormPopUp.dart';
...
class Login extends StatefulWidget {
  ...
  @override
  State<Login> createState() => _LoginStripe();
}

class _LoginStripe extends State<Login> {
        ...
        child: ListView(
          ...
          children: [
            Container(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center, // Aligne image et texte au centre
                children: [
                  Container(
                    child: Image.asset(
                      "assets/76-766827_transparent-mobile-phone-icon-mobile-logo-png-transparent.png",
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          height: 38,
                          margin: EdgeInsets.only(left: 45, right: 40 , top: 15),
                          child: MaterialButton(
                            shape: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(50),
                                ...
                                Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Container(
                                        margin: EdgeInsets.only(left: 43, top: 8.5),
